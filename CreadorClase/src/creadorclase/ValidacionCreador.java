...
class ValidacionCreador {
    ...
    public void crearServicio() throws Exception {
        ...
        Path file = Paths.get("src/creadorclase/template/validacion.txt");
        ...
        Path fileNuevo = Paths.get("src/com/aw/hotel/servicio/validacion/impl/Validacion" + nombre + "Impl.java");
    ...
    private void crearInterface() throws Exception {
        StringBuilder stringBuilder = new StringBuilder();
        String lineSeparator = System.getProperty("line.separator");
        Path file = Paths.get("src/creadorclase/template/validacionInterface.txt");
        Scanner scanner = new Scanner(new FileInputStream(file.toFile()));
        try {
            while (scanner.hasNextLine()) {
                stringBuilder.append(scanner.nextLine() + lineSeparator);
        ...
        Path fileNuevo = Paths.get("src/com/aw/hotel/servicio/validacion/definicion/IValidacion" + nombre + ".java");
        if (!Files.exists(fileNuevo.getParent())) {
            Files.createDirectories(fileNuevo.getParent());
        }
